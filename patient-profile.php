                        ...
                        <center>
                            <div class="profile-info-widget">
                                <a href="#" class="booking-doc-img">
                                    <img style="" src="<?php echo "Photos/" . $login_row['Photo']; ?>" alt="Patient Image">
                                </a>
                                <div class="profile-det-info">
                                    <h3> <?= $login_row['Pname']; ?></h3>
                                    <div class="doctor-details">
                                        <p class="mb-0">Patient Id : <?= $login_row['Patients_Id']; ?></p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <a href="patientdash.php"><button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            ...
                            <form action="update-patient.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input name="allergies" type="text" class="form-control" value="<?= $login_row['Allergies']; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label>Full Name</label>
                                    <input name="name" type="text" class="form-control" value="<?= $login_row['Pname']; ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Father's Name</label>
                                    <input name="name" type="text" class="form-control" value="<?= $login_row['PFname']; ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                ...
                                <div class="form-group">
                                    <label>DOB</label>
                                    <input name="dob" type="date" class="form-control" value="<?= $login_row['DOB']; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label>Phone Number</label>
                                    <input type="tel" id="tel" pattern="[1-9]{1}[0-9]{9}" title="Please enter exactly 10 digits" maxlength="10" name="mnumber" value="<?= $login_row['Phone']; ?>" class="form-control form-control-lg" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10)" ;>
                                ...
                                <div class="form-group">
                                    <label>Pincode</label>
                                    <input name="pincode" type="text" class="form-control" value="<?= $login_row['Pincode']; ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 6)" required>
                                </div>
