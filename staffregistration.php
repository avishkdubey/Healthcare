                        ...
                        <div class="card card-registration my-4">
                            <div class="row g-0">
                                <div class="col-xl-6 d-none d-xl-block">
                                    <img src="Images\mobile-3998329.png" alt="Health Care" class="img-fluid" style="border-top-left-radius: .25rem; border-bottom-left-radius: .25rem; height: 100%;" />
                                </div>
                                <div class="col-xl-6">
                                    <form action="" id="form">
                                        ...
                                        <div class="card-body p-md-5 text-black">
                                            ...
                                            <div class="row">
                                                <div class="col mb-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="staff-designation" name="staff-designation" required>
                                                            <option value="">--Please Select--</option>
                                                            <option value="program-manager">Program Director or Manager</option>
                                                            <option value="medical-director">Medical Director</option>
                                                            <option value="administrative-staff">Administrative Staff</option>
                                                        </select>
                                                        <label for="staff-designation">Select Staff Designation:</label>
                                                    </div>
                                            ...
                                            <div class="form-outline mb-4">
                                                <input type="email" name="email" id="email" class="form-control form-control-lg" placeholder="" required />
                                            ...
                                            <div class="col-md-6 form-outline mb-4">
                                                <input type="tel" id="tel" pattern="[1-9]{1}[0-9]{9}" title="Please enter exactly 10 digits" maxlength="10" name="mnumber" value="" class="form-control form-control-lg" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);" required>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data == '4') {
                            ...
                            alert("Candidate age must be 21 or older to submit the form.");
                        } else if (data == '5') {
                            alert('Aadhaar Number Already exits in our records Please use diffrent');
                        } else if (data == '1') {

                            alert('Staff Member Has Been Registered Sucessfully. verify Your email **Verification OTP sent to you mail id** ');
                            $('#form')[0].reset();
                            $('.preview').attr("src", "Images/user.jpg");
                            window.location = "staff-verification.php";
                        } else if (data == '2') {
                            alert('Error');
                        } else if (data == '3') {
