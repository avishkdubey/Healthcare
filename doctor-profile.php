                        ...
                        <center>
                            <div class="profile-info-widget">
                                ...
                                <div class="profile-det-info">
                                    <h3>Dr. <?= $login_row['Dname']; ?></h3>
                                    <div class="doctor-details">
                                        <p class="mb-0">Staff Id : <?= $login_row['Doctor_Id']; ?></p>
                                        <p class="mb-0"><i class="fas fa-user-md"></i> <?= $login_row['Medical_Specialization']; ?></p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <a href="doctordash.php"><button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            ...
                            <form action="update-doc.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input name="name" type="text" class="form-control" value="<?= $login_row['Dname']; ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                    <input name="email" type="email" class="form-control" value="<?= $login_row['Email']; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label>Aadhaar</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" id="tel" pattern="[1-9]{1}[0-9]{9}" title="Please enter exactly 10 digits" maxlength="10" name="mnumber" value="<?= $login_row['Phone']; ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10)" class="form-control form-control-lg">
