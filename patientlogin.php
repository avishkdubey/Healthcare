...
<?php
  ...
  if (isset($_SESSION['Patients_Id'])) { // if session already exists, redirect to admin dashboard
  ...
  if (isset($_POST['login'])) {
    ...
    if (mysqli_num_rows($result) == 1) { // if staff exists with provided credentials
      $row = mysqli_fetch_assoc($result);

      $_SESSION['Patients_Id'] = $row['Patients_Id']; // create session for Patient
      $_SESSION['Pname'] = $row['Pname'];

  ?>
      <script>
        location.replace("patientdash.php?patientsid=<?php echo $_SESSION['Patients_Id'] ?> ")
      </script>
  <?php
      exit();
            ...
            <div class="card" style="border-radius: 1rem;">
              <div class="row g-0">
                <div class="col-md-6 col-lg-5 d-none d-md-block">
                  <img src="Images\corona-4960366.jpg" alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem;" />
                </div>
                <div class="col-md-6 col-lg-7 d-flex align-items-center">
                  <div class="card-body p-4 p-lg-5 text-black">
                    ...
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
                      ...
                      <a class="small text-active" id="forgot" href="petientregistration.php">New Patients Registeration </a><br>
                      <a class="small text-muted" id="forgot" href="recover-patient-pass.php">Forgot password?</a>&nbsp;&nbsp;
